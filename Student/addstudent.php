...
&& isset($_POST['stuclass']) && isset($_POST['stupass'])){
// Adding data to database by using sql queries
$stuname = $_POST['stuname'];
$stuemail = $_POST['stuemail'];
$stuclass = $_POST['stuclass'];
$stupass = $_POST['stupass'];

$sql = "INSERT INTO student(stu_name,stu_email,stu_class,stu_pass) VALUES ('$stuname','$stuemail','$stuclass','$stupass')";
